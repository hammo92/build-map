...
import { ContentTemplateIcon as ContentTemplateIconProps } from "@lib/contentTemplate/data/contentTemplate.model";
...
export const ContentTemplateIcon = () => {
    ...
    if (data?.contentTemplate?.icon && hasEditPermission)
        return <IconEdit defaultValue={data.contentTemplate.icon} />;
