...
import { generateTaskTemplate } from '../../../lib/task/utils/utils'
...
export async function createOrganisation({
    ...
    await Promise.all([
        ...
        generateTaskTemplate(newOrganisation.id),
    ])
...
export async function updateOrganisation({
    ...
    if (
        ...
        throw new Error(
            "You don't have the correct permission to delete this organisation"
        )
    }
